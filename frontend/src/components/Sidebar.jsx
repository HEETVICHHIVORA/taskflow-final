...
export const Sidebar =({tasks,settasks,setaddbtn,setaddbtnfortext,createteam,setkickbtn})=>{
    ...
    return <div className="w-[30%] h-screen mt-20">
        ...
        {groups?.map((group,index)=>{
            return (
                <Team group={group} settasks={settasks} setaddbtn={setaddbtn} setaddbtnfortext={setaddbtnfortext} setkickbtn={setkickbtn} createteam={createteam}/>
            )
        })}
