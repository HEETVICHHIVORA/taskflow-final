...
export const Appbar=({addbtn,createTeam,addbtnfortext,kickbtn})=>{
    ...
    return   <div className="w-full fixed z-10 bg-gray-50 text-gray-800 border-b border-gray-300 flex justify-between items-center px-6 md:px-10 py-4 shadow-md">
